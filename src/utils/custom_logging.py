...
from collections.abc import MutableMapping  # noqa: TCH003
...
def add_app_context(
    _, __, event_dict: MutableMapping[str, Any]
) -> MutableMapping[str, Any]:
    """
    Add the current starlette_context's context to the event dict.
    """
    if context.exists():
...
def setup_logging(json_logs: bool = False, log_level: str = "INFO"):
    ...
    if json_logs:
        ...
        shared_processors.append(EventRenamer(to="message"))
